...
export deg_box2=${deg_box2:-45} #45
...
#                                    [--interpolation_points=5 (default is 4, range 1-500) ]
  ...
  ln -sf ${tcvital} fort.11
  ln -sf ./trak.fnl.all fort.30
  ln -sf ../prep_guess/vi_inp_${deg_box1}deg0p02.bin ./fort.26
  ln -sf ../prep_guess/vi_inp_${deg_box2}deg0p20.bin ./fort.46
  # output
  ...
  #echo ${gesfhr} $ibgs $vmax_vit $iflag_cold $crfactor | ${APRUNC} ./hafs_vi_split.x
  ...
  ln -sf ../prep_guess/vi_inp_${deg_box1}deg0p02.bin fort.46
